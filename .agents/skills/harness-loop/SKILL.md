...
| **verify** | required deterministic gates must be green; then approve ship | `basicly verify --mode full --issue <id>`; `basicly policy gate <id>`; `basicly policy checkpoint <id> ship --approve` |
