...
<!-- Source fragments: require-explicit-confirmation, project-defaults, no-user-path-leakage, core-rules, quality-gate, use, python-style, claude-defaults, if-stuck -->
# Claude Defaults
