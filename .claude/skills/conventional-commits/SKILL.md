...
- `description` — required: **entirely lowercase, not just the first letter** — proper
  ...
  least 3 characters. This means version strings and filenames (`v0.1.0`,
  `AGENTS.md`) can never appear verbatim — dots and uppercase are rejected; reword
  them ("the first release", "agents-md", "the readme").
